...
export function toRequestVoidHandler<HandlerT extends AsyncRequestVoidHandler<RouteData>> (
    handler : HandlerT
...
export function toErrorVoidHandler<HandlerT extends AsyncErrorVoidHandler<RouteData>> (
    handler : HandlerT
